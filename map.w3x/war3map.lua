...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("H00Q"), 670.1, -14403.6, 247.890, FourCC("H00Q"))
    SetHeroLevel(u, 20, false)
    SelectHeroSkill(u, FourCC("A00T"))
    SelectHeroSkill(u, FourCC("A00T"))
    SelectHeroSkill(u, FourCC("A00T"))
    SelectHeroSkill(u, FourCC("A00T"))
    ...
    IssueImmediateOrder(u, "")
    u = BlzCreateUnitWithSkin(p, FourCC("H00S"), 551.9, -14228.3, 25.700, FourCC("H00S"))
    SetHeroLevel(u, 20, false)
