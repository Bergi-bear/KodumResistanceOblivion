...
function CreateAllItems()
    local itemID
    BlzCreateItemWithSkin(FourCC("tkno"), -3350.2, -10037.5, FourCC("tkno"))
    BlzCreateItemWithSkin(FourCC("tkno"), -3274.8, -10040.9, FourCC("tkno"))
    BlzCreateItemWithSkin(FourCC("tkno"), -3201.8, -10027.1, FourCC("tkno"))
    BlzCreateItemWithSkin(FourCC("tkno"), -3448.8, -10125.9, FourCC("tkno"))
    BlzCreateItemWithSkin(FourCC("tkno"), -3365.3, -10132.4, FourCC("tkno"))
    BlzCreateItemWithSkin(FourCC("tkno"), -3276.6, -10146.8, FourCC("tkno"))
    BlzCreateItemWithSkin(FourCC("tkno"), -3437.9, -10028.9, FourCC("tkno"))
end
...
function CreateUnitsForPlayer0()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("H00S"), -3335.4, -9841.6, 270.000, FourCC("H00S"))
    SetHeroLevel(u, 19, false)
    ...
    SetHeroLevel(u, 30, false)
    SetUnitState(u, UNIT_STATE_MANA, 750)
    u = BlzCreateUnitWithSkin(p, FourCC("H00X"), -2692.0, -10037.1, 270.000, FourCC("H00X"))
    SetHeroLevel(u, 30, false)
